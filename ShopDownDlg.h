...
protected:
    ...
    afx_msg void OnTimer(UINT_PTR nIDEvent);    virtual BOOL PreTranslateMessage(MSG* pMsg);  // �ڽ� ��Ʈ�� �� �� ĸó
...
// ---------- Layout constants (96-DPI base, Scale() at runtime) -------------
    static const int kHdrAreaH = 44;   // Ÿ��Ʋ ��� ���� ����
    static const int kSecGapT  = 6;    // ���~����ī�� ��� ����
    static const int kSecM     = 18;   // ����ī�� �¿��ϴ� ���� (�ٸ� �ǰ� ����)
    static const int kColHdrH  = 0;   // �÷� ��� �� ����
    ...
    // kHdrAreaH/kSecGapT�� fixed px, kColHdrH�� DPI ������
