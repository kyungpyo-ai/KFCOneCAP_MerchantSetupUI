...
## Project Root
All file edits must use the path `C:\Project\MerchantSetup_OnPaintIcons_Clean_CP949` as the project root. Do not edit files under any other path.
...
> **���� (�ѱ���):**
> - ��� �÷���: Win32 (x86 ����), Windows 10 SDK, MSVC v143 (VS2022)
> - MFC: ���� ���� (UseOfMfc=Dynamic)
> - ���ڼ�: MultiByte (CP949) ? �ҽ� ������ CP949(�ѱ���) ���ڵ�. UTF-8�� ��ȯ ����.
> - �̸� �����ϵ� ��� �̻��
